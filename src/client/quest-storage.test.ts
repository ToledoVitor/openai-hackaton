...
describe("persistQuestState", () => {
  ...
  test.each([
    ...
    ["repairs without a submitted attempt", JSON.stringify({
      version: 1,
      discoveredNeeds: ["accessibleEntrance", "clearSign", "weatherCover"],
      passedNeeds: ["accessibleEntrance"],
      attemptCount: 0,
    ...
    ["completed Town Hall without a submitted attempt", JSON.stringify({
      version: 1,
      discoveredNeeds: ["accessibleEntrance", "clearSign", "weatherCover"],
      passedNeeds: ["accessibleEntrance", "clearSign", "weatherCover"],
      attemptCount: 0,
    ...
    ["help tier without the Prompt Blueprint", JSON.stringify({
      version: 1,
      discoveredNeeds: ["accessibleEntrance", "clearSign", "weatherCover"],
      passedNeeds: [],
      attemptCount: 1,
    ...
    ["Prompt Blueprint without raised help", JSON.stringify({
      version: 1,
      discoveredNeeds: ["accessibleEntrance", "clearSign", "weatherCover"],
      passedNeeds: [],
      attemptCount: 1,
    ...
    ["fallback source without a submitted attempt", JSON.stringify({
      version: 1,
      discoveredNeeds: [],
      passedNeeds: [],
      attemptCount: 0,
