...
export const UI_COPY: Record<Language, UiCopy> = {
  portuguese: {
    ...
    choose_mission: "Escolha sua primeira missão", choose_mission_label: "Três caminhos disponíveis",
    choose_mission_help: "Comece por moradia, saúde ou diagnóstico urbano. A recomendação é apenas uma sugestão; você pode trocar quando quiser.",
  ...
  english: {
    ...
    choose_mission: "Choose your first mission", choose_mission_label: "Three paths available",
    choose_mission_help: "Start with housing, health, or urban diagnosis. The recommendation is only a suggestion; switch whenever you want.",
