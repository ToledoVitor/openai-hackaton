...
- 246 offline tests across 44 files pass; typecheck, lint, production build pass.
...
- Final chunks after logo exclusion: page 17,488 B; bootstrap 4,432 B; post-entry runtime 724,662 B; explicit-action Realtime 4,386 B raw.
